    ...
    internal class Program {
        static void Main(string[] args) {
            ...
            for (int i = 0; i < mapArray.GetLength(0); i++) {
                ...
                if (mapArray[i, 0] == "AAA") {
                    index = i;
                    Console.WriteLine("AAA Found at index {0}", index);
            ...
            while (searching) {
                ...
                if (arrayFirstIndex == mapArray.GetLength(0)) {
                    arrayFirstIndex = 0;
                }
                else if (mapArray[arrayFirstIndex, arraySecondIndex] == "ZZZ") {
                    Console.WriteLine("Found ZZZ found at " + arrayFirstIndex +" "+ arraySecondIndex);
